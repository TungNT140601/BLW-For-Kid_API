...
namespace WebAPI.Controllers
{
    ...
    public class CustomersController : ControllerBase
    {
        ...
        //[HttpGet]
        //public IActionResult GetPaymentVNPayUrl(double price, string ipAddress)
        //{
        //    var paymentInfo = configuration.GetSection("PaymentVNPay");
        ...
        //}
        [HttpGet]
        public async Task<IActionResult> GetPaymentMomoUrl(string packageId, string ipAddress)
        {
            return Ok();
        }
    }
